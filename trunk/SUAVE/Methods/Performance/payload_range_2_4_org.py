...
## @ingroup Methods-Performance
def payload_range_2_4_org(vehicle,mission,cruise_segment_tag,reserves=0.):
...
##    for i in [2]:
    ...
    # packing results
    payload_range_2_4_org.range     = np.multiply(R,1.0*Units.nautical_mile / Units.m) # [m]
    payload_range_2_4_org.payload   = PLD
    payload_range_2_4_org.fuel      = FUEL
    payload_range_2_4_org.takeoff_weight = TOW
    payload_range_2_4_org.reserves = reserves
